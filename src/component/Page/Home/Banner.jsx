    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <div className="col-span-2">
                ...
                <h3 className="text-6xl font-bold mb-3">I am Ron a Creative</h3>
                <h3 className="text-6xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-red-500 to-pink-500"  >Developer & UI Expert</h3>
