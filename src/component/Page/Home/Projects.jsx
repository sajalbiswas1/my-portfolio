...
const Projects = () => {
    ...
    return (
        <div className="max-w-7xl m-auto">
            <h2 className="text-5xl font-bold mt-10 text-center max-w-min m-auto bg-clip-text text-transparent bg-gradient-to-r from-cyan-500  to-pink-500">Projects</h2>
